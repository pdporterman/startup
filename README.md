...
startup react: got the websight converted and working, hooks were implimented to allow code to run as soon as the componant is loaded, each of the pages is now a component that arre called by the router